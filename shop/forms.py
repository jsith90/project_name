...
class UserInfoForm(forms.ModelForm):
	...
	region = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Region'}), required=False)
	...
	class Meta:
		model = Profile
		fields = ['address1', 'address2', 'city', 'region', 'postcode', 'country']
